...
import (
	...
	"github.com/albrow/gqlgen-todos/graph/model"
...
func (ec *executionContext) _Todo_number(ctx context.Context, field graphql.CollectedField, obj *model.Todo) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
	...
	res := resTmp.(*big.Int)
	fc.Result = res
	return ec.marshalOBigNumber2ᚖmathᚋbigᚐInt(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalOBigNumber2ᚖmathᚋbigᚐInt(ctx context.Context, v interface{}) (*big.Int, error) {
	...
	res, err := ec.unmarshalOBigNumber2mathᚋbigᚐInt(ctx, v)
	return &res, err
}
...
func (ec *executionContext) marshalOBigNumber2ᚖmathᚋbigᚐInt(ctx context.Context, sel ast.SelectionSet, v *big.Int) graphql.Marshaler {
	...
	return ec.marshalOBigNumber2mathᚋbigᚐInt(ctx, sel, *v)
}
